...
while True:
    ...
    if event == 'Receber':
        ...
        sg.popup('Arquivos disponíveis:', *files_list(arquivos_servidor), background_color='white', text_color='black', no_titlebar=True, keep_on_top=True)
    ...
    if event == 'Listagem':
        arquivos_servidor = listar_arquivos_servidor()
        sg.popup('Arquivos presentes no servidor:', *files_list(arquivos_servidor), background_color='white', text_color='black', no_titlebar=True, keep_on_top=True)
